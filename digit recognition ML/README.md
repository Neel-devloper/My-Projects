Run the init weights and biases.py to generate random weights and biases for the model to start with and stores them in a new file called "neural network.db".
